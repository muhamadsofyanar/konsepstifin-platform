...
const journeys = [
  ...
  },
  {
    ...
    description: 'Belum siap menjadi promotor? Mulai dengan merekomendasikan layanan melalui tautan referral dan sistem pencatatan SEJOLI.',
    href: '/affiliate', action: 'Saya ingin mengenal affiliate', tone: 'leaf',
  },
];

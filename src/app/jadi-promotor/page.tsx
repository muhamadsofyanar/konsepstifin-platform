  ...
  return <div className="public-site journey-site promoter-landing">
    ...
    <main>
      <section className="promoter-hero">
        <div><span className="eyebrow">JALUR PROMOTOR STIFIn</span><h1>Ingin membantu orang memahami hasil STIFIn, sekaligus membangun layanan Anda sendiri?</h1><p>Lihat pekerjaan nyata seorang promotor, tahapan belajar, biaya, dan syarat aktivasi sebelum membeli alat atau mengambil keputusan.</p><div className="hub-actions"><Link className="public-cta big" href="#tahapan">Lihat tahap & biayanya →</Link><Link href="/affiliate">Belum siap? Bandingkan affiliate</Link></div></div>
      ...
      <section id="tahapan" className="section promoter-section">
        <div className="section-heading"><span>PROGRAM, MANFAAT & BIAYA</span><h2>Mulai dari Preview. Lanjutkan hanya jika peran dan biayanya memang sesuai.</h2><p>Bandingkan isi setiap tahap, biaya, fasilitas, dan tindakan berikutnya. Harga serta ketentuan final tetap mengikuti produk aktif di SEJOLI.</p></div>

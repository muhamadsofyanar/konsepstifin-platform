...
export default function KnowledgeManager({
  ...
  return <div className="article-admin knowledge-admin">
    <header className="article-admin-header"><Link href="/"><Image src="/stifin-konsep-wordmark.png" alt="STIFIn Konsep" width={419} height={168} priority /></Link><nav><span>Portal Tim</span><b>Pustaka STIFIn</b></nav><div><Link href="/admin/artikel">Kelola artikel</Link><Link href="/edukasi" target="_blank">Lihat edukasi ↗</Link><button onClick={logout}>Keluar</button></div></header>
    <main>

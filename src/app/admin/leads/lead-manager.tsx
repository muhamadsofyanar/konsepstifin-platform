...
export default function LeadManager({ databaseReady, initialLeads, initialError }: { databaseReady: boolean; initialLeads: StoredLead[]; initialError: string }) {
  ...
  return <main className="lead-admin"><header><div><span>PUSAT LAYANAN NASIONAL</span><h1>Koordinasi lead</h1><p>Kelola permintaan konsumen tanpa membuka data pribadi di halaman publik.</p></div><div className="lead-admin-links"><a href="/admin/promotor">Pemetaan promotor →</a><a href="/admin/artikel">Dashboard artikel →</a></div></header>

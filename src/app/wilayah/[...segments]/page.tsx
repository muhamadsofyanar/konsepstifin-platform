...
import { getPublicPromoters, getServedRegionCodes, regionMappingCovers } from '@/lib/promoter-store';
...
export async function generateMetadata({ params }: { params: Promise<{ segments: string[] }> }): Promise<Metadata> {
  ...
  let served = false;
  try { served = (await getServedRegionCodes()).some((mappedCode) => regionMappingCovers(item.code, mappedCode)); } catch { served = false; }

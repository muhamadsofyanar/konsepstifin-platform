  ...
  return <div className="public-site journey-site test-landing">
    ...
    <main>
      <section className="hero test-hero">
        <div className="hero-copy"><div className="eyebrow">TES STIFIn · OFFLINE BERSAMA PROMOTOR</div><h1>Sudah mencoba banyak cara, tetapi tetap belum tahu mana yang paling pas untuk Anda?</h1><p>Kenali Mesin Kecerdasan dominan melalui pemindaian sepuluh sidik jari. Setelah tes, promotor membantu Anda memahami hasilnya dan memilih penerapan yang relevan untuk situasi nyata.</p><div className="hero-actions"><Link className="public-cta big" href="#layanan">Bandingkan paket & biaya <span>→</span></Link><Link href="#proses">Lihat 4 langkah tes</Link></div><div className="trust-row"><span><b>Offline</b><small>pemindaian langsung</small></span><span><b>Terjadwal</b><small>sesuai kota peserta</small></span><span><b>Dibahas</b><small>bersama promotor</small></span></div></div>

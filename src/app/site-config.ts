...
export const publicProducts: PublicProduct[] = [
  ...
  },
  {
    ...
    price: 'Rp0',
    priceNote: 'pendaftaran awal tanpa biaya · ketentuan mengikuti checkout SEJOLI',
    features: [
...
export const affiliatePrograms = [
  {
    ...
    price: 'Rp1',
    priceNote: 'nominal aktivasi checkout · komisi diatur di SEJOLI',
  ...
  },
  {
    ...
    price: 'Rp1',
    priceNote: 'nominal aktivasi checkout · khusus promotor aktif yang memenuhi syarat',

  ...
  return <div className="public-site journey-site affiliate-landing">
    ...
    <main>
      <section className="affiliate-hero">
        <div><span className="eyebrow">PROGRAM AFFILIATE KONSEP STIFIn</span><h1>Ingin merekomendasikan Tes STIFIn tanpa harus menjalankan tes sendiri?</h1><p>Pilih program affiliate, gunakan tautan referral pribadi, dan arahkan calon peserta ke layanan yang relevan. Transaksi valid dan komisi dicatat melalui SEJOLI.</p><div className="hub-actions"><Link className="public-cta big" href="#program">Bandingkan program affiliate →</Link><a href={platformLinks.affiliateDashboard} target="_blank" rel="noopener noreferrer">Sudah terdaftar? Masuk Affiliate ↗</a></div></div>
